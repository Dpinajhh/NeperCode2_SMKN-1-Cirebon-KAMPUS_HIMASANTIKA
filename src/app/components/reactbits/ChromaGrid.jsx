    ...
    >
      {data.map((c, i) => (
        <article
          ...
          className="group relative flex flex-col w-full sm:w-[calc(50%-12px)] lg:w-[calc(33.333%-16px)] min-h-[220px] rounded-[28px] overflow-hidden border-2 border-transparent transition-colors duration-300 cursor-pointer p-6"
          style={{
        ...
        >
          ...
          <div className="relative z-10 flex flex-col justify-center h-full">
            ...
            <p className="text-sm text-white/70 leading-relaxed">{c.subtitle}</p>
          </div>
        </article>
      ))}
      <div
